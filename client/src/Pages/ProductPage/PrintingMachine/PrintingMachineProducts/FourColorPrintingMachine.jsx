...
import KomoriLithrone440One from "../../../../assets/FourColorMachineImage/KomoriLithrone440One.jpeg";
import KomoriLithrone440Two from "../../../../assets/FourColorMachineImage/KomoriLithrone440Two.jpeg";
import Ryobi3304FourColorImageOne from "../../../../assets/FourColorMachineImage/Ryobi3304FourColorImageOne.jpeg";
import Ryobi3304FourColorImageTwo from "../../../../assets/FourColorMachineImage/Ryobi3304FourColorImageTwo.jpeg";
import Ryobi3304FourColorImageThree from "../../../../assets/FourColorMachineImage/Ryobi3304FourColorImageThree.jpeg";
import Ryobi3304FourColorImageFour from "../../../../assets/FourColorMachineImage/Ryobi3304FourColorImageFour.jpeg";
import Ryobi3304FourColorImageFive from "../../../../assets/FourColorMachineImage/Ryobi3304FourColorImageFive.jpeg";
import Ryobi3304FourColorImageSix from "../../../../assets/FourColorMachineImage/Ryobi3304FourColorImageSix.jpeg";
import Ryobi3304FourColorImageSeven from "../../../../assets/FourColorMachineImage/Ryobi3304FourColorImageSeven.jpeg";

const FourColorPrintingMachine = () => {
  ...
  const products = [
    {
      id: 1,
      name: "1992 HEIDELBERG 102 4 COLOR",
      images: [
      ...
      description:
        "Available for advance booking, this 1992 Heidelberg 102 four-color straight press is imported from Canada and is in like new condition. Equipped with Alcolor dampening, CPC 1-02 for color control, and a Grafix powder spray system, it delivers reliable performance and consistent print quality. Ideal for commercial print jobs requiring precision and durability.",
      features: [
        "4-Color Straight",
        "Alcolor Dampening",
        "CPC 1-02",
    ...
    {
      id: 2,
      name: "Komori Lithrone 440",
      images: [
        KomoriLithrone440Two,
        KomoriLithrone440Two,
        KomoriLithrone440Two,
        KomoriLithrone440Two,
      ],
      description:
        'This Komori Lithrone 440 (New Lithrone) is a four-color straight offset press, manufactured in 1991, with a sheet size of 28" x 40". It features Alcolor Komorimatic dampening, fully equipped PQC for ink and register control, and hard chromed impression cylinders for extended durability and consistent print quality. A reliable choice for commercial print operations requiring long-lasting performance and precision.',
      features: [
        "4-Color Straight",
        "PQC System",
    ...
    {
      id: 3,
      name: "ADAST 747 4 colour STRAIGHT",
      images: [
        KomoriLithrone440One,
        KomoriLithrone440One,
        KomoriLithrone440One,
        KomoriLithrone440One,
      ],
      description:
        "The ADAST 747 is a 4-color straight offset press, built in 2005, with a compact 19” x 26” format. It features alcohol dampening with refrigeration, INKDOT semi-CPC system, and powder spray for clean delivery. With a very low impression count, this machine is in excellent condition and ideal for short to medium-run commercial print jobs.",
      features: [
        "4-Color Straight",
        "Alcohol Dampening",
        "INKDOT System",
    ...
    {
      id: 4,
      name: "RYOBI 3304HA – 4 Color Offset Press",
      images: [
        Ryobi3304FourColorImageOne,
        Ryobi3304FourColorImageTwo,
        Ryobi3304FourColorImageThree,
        Ryobi3304FourColorImageFour,
        Ryobi3304FourColorImageFive,
        Ryobi3304FourColorImageSix,
        Ryobi3304FourColorImageSeven,
      ],
      description:
        "The RYOBI 3304HA is a compact 4-color offset press, manufactured in 2006, with a 13” x 19” sheet size—perfect for high-quality short-run jobs like brochures, stationery, and packaging. It comes equipped with Autoplate, ink console (CPC), and both Ryobi Matic and Alcolor dampening systems. This is an excellent running machine, known for its reliability, quick makeready, and high print quality.",
      features: [
        "4-Color Straight",
        "Alcohol Dampening",
        "INKDOT System",
        ...
        <div className="container mx-auto">
          ...
          >
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Discover our comprehensive collection of world-class four color
              printing machines from industry leaders Heidelberg, Ryobi, Komori
              and Adast
            </p>
          </div>
...
export default FourColorPrintingMachine;
